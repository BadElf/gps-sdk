...
class ConfigurationViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let _ = sessionController.openSession()
...
extension String {
    func dataFromHexadecimalString() -> NSData? {
        let trimmedString = self.trimmingCharacters(in: (NSCharacterSet(charactersIn: "<>".replacingOccurrences(of: " ", with: "")) as CharacterSet))
        ...
        while index < trimmedString.endIndex {
            let byteString = trimmedString[index...trimmedString.index(index, offsetBy:1)]
